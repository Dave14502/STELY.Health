    ...
    <div className="w-full bg-white">
      ...
      <section className="w-full bg-white">
        ...
        <style>{`
          ...
          .animate-float-delay-2 { animation-delay: 0.2s; }
          .animate-float-delay-3 { animation-delay: 0.4s; }
          .animate-float-delay-4 { animation-delay: 0.6s; }
          .animate-float-delay-5 { animation-delay: 0.8s; }
        `}</style>
        <div className="w-full bg-white border-t border-gray-200 px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="flex flex-col items-center gap-3 animate-float animate-float-delay-1">
              ...
              <div className="flex flex-col items-center gap-3 animate-float animate-float-delay-2">
                <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
                  <svg className="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <p className="text-gray-700 font-medium text-sm text-center">Analyse in DAkkS-akkreditierten Laboren nach DIN EN ISO 15189</p>
              </div>
              <div className="flex flex-col items-center gap-3 animate-float animate-float-delay-3">
                <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center">
                  <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                  </svg>
                </div>
                <p className="text-gray-700 font-medium text-sm text-center">Datenschutz nach DSGVO mit Verarbeitung auf EU-Servern</p>
              </div>
              <div className="flex flex-col items-center gap-3 animate-float animate-float-delay-4">
                ...
                <p className="text-gray-700 font-medium text-sm text-center">Medizinisch validierte Auswertung durch qualifiziertes Fachpersonal</p>
              </div>
              <div className="flex flex-col items-center gap-3 animate-float animate-float-delay-5">
                ...
                <p className="text-gray-700 font-medium text-sm text-center">Zusammenarbeit mit geprüften deutschen Partnerlaboren</p>
              </div>
            </div>
          </div>
        </div>
