export default function WayBetter() {
  return (
    <section className="w-full py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-50/40 to-white border-t border-gray-200">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-2xl font-bold text-center mb-8">Wie 10x weniger.</h3>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-2xl font-bold text-center mb-8">Warte nicht auf deinen Kaffee und überspringe nicht dein Training.</h3>
            <div className="w-full h-96 rounded-2xl bg-gradient-to-br from-gray-100 to-gray-50 flex items-center justify-center border border-gray-200">
              <div className="text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-2xl font-bold text-center mb-8">Wir verfolgen die Marker, die wichtig sind.</h3>
            <div className="w-full h-96 rounded-2xl bg-gradient-to-br from-gray-100 to-gray-50 flex items-center justify-center border border-gray-200">
              <div className="text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-2xl font-bold text-center mb-8">Monatliches Tracking macht es einfach, dein Bestes zu zeigen.</h3>
            <div className="w-full h-96 rounded-2xl bg-gradient-to-br from-gray-100 to-gray-50 flex items-center justify-center border border-gray-200">
              <div className="text-center">
                <div className="text-6xl font-bold text-gray-300 mb-4">💪</div>
