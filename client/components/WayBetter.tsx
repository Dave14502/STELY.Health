      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="flex flex-col items-center">
            <h3 className="text-2xl lg:text-3xl font-bold text-center mb-4 text-gray-900">
              Weniger Blut
            </h3>
            <p className="text-lg font-semibold text-center mb-4 text-gray-900">
              10-mal weniger Blut als beim Arzt
            </p>
            <p className="text-base text-gray-700 text-center mb-8">
              Nur ein paar Tropfen. Keine Nadel-Angst.
            </p>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-base text-gray-700 text-center mb-8">
              Kein Arzttermin. Keine Wartezimmer. Dein Timing.
            </p>
            <div className="w-full h-80 lg:h-96 rounded-xl bg-gray-50 border border-gray-200 flex items-center justify-center overflow-hidden">
              <img
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-lg font-semibold text-center mb-4 text-gray-900">
              Nur die Marker, die zählen
            </p>
            <p className="text-base text-gray-700 text-center mb-8">
              Nur die Tests, die zählen. Keine Verschwendung.
            </p>
            <div className="w-full h-80 lg:h-96 rounded-xl bg-gray-50 border border-gray-200 flex items-center justify-center overflow-hidden">
              <img
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-lg font-semibold text-center mb-4 text-gray-900">
              Monatliches Tracking zeigt Muster
            </p>
            <p className="text-base text-gray-700 text-center mb-8">
              Trends statt Momentaufnahmen. Echte Fortschritte.
            </p>
            <div className="w-full h-80 lg:h-96 rounded-xl bg-gray-50 border border-gray-200 flex items-center justify-center overflow-hidden">
              <img
