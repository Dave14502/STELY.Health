...
const testCategories: TestCategory[] = [
  ...
  },
  {
    ...
    icon: Leaf,
    items: [
      { id: '11', name: 'Ferritin (Eisen)', description: 'Zeigt deine gespeicherten Eisenwerte an. Essenziell für den Sauerstofftransport und eine konstante Energieproduktion.' },
      { id: '12', name: 'Albumin', description: 'Ein Protein, das den Flüssigkeitshaushalt reguliert und Hormone sowie Vitamine im Blut transportiert.' },
      { id: '13', name: 'Free T3 (Schilddrüse)', description: 'Free T3 ist das aktive Schilddrüsenhormon und reguliert Stoffwechsel, Energie und Körpertemperatur.' },
      { id: '14', name: 'Vitamin D', description: 'Vitamin D unterstützt das Immunsystem, die Knochengesundheit und die Hormonregulation.' },
      { id: '15', name: 'Triglyceride', description: 'Triglyceride sind eine Fettart im Blut und zeigen, wie dein Körper Energie speichert und verarbeitet.' },
      { id: '16', name: 'LDL-C / ApoB (Partikelgröße)', description: 'Dieses Verhältnis zeigt, wie effektiv dein Körper Cholesterin verarbeitet. Es unterstützt stabile Energie, gute Durchblutung und langfristige Vitalität.' },
      { id: '17', name: 'Triglyceride / HDL', description: 'Dieses Verhältnis ist ein wichtiger Marker für Insulinsensitivität und die metabolische Gesundheit.' },
    ],
  },
  {
    title: 'Langlebigkeit',
