      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-20">
          ...
          <div className="flex flex-col items-center">
            <div className="w-12 h-12 rounded-full border-2 border-blue-500 flex items-center justify-center text-blue-500 font-bold text-lg mb-6">
              1
            </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-2xl font-bold text-blue-500 mb-10">Sende deine Probe</h3>
            <div className="w-full max-w-2xl rounded-2xl overflow-hidden bg-gray-100 h-96 flex items-center justify-center">
              <img
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-2xl font-bold text-blue-500 mb-10">Ergebnisse in Tagen erhalten</h3>
            <div className="w-full max-w-2xl rounded-2xl overflow-hidden bg-gray-100 h-96 flex items-center justify-center">
              <img
